#!/bin/bash
# Complete VPS Fix - Run this on your VPS terminal
# This will fix all auth pages and rebuild
...
echo "📝 Step 1: Fixing auth pages with Suspense boundaries..."

# Fix register page
cat > src/app/auth/register/page.tsx << 'EOFREGISTER'
"use client";
...
# Fix signin page
cat > src/app/auth/signin/page.tsx << 'EOFSIGNIN'
"use client";
...
# Fix signout page
cat > src/app/auth/signout/page.tsx << 'EOFSIGNOUT'
"use client";
...
if [ $? -eq 0 ]; then
  ...
  pm2 status
  echo ""
  echo "✅ Your application should now be running perfectly!"
  echo "📝 View logs with: pm2 logs ishk-platform"
else
  echo ""
